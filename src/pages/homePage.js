            ...
            <Row className="midsec1">
                <Col xs='12' md='3' className="helpedRaise rounded pt-5 pb-5">
                    <FloatIn delay={0}>
                        ...
                        <img className="img img-fluid rounded" src={volunteers} alt='volunteers' />
                    </FloatIn>
                </Col>
                <Col xs='12' md='3' className="foodDonated rounded pt-5 pb-5">
                    <FloatIn delay={0.2}>
                        ...
                        <img className="img img-fluid rounded" src={food} alt='food' />
                    </FloatIn>
                </Col>
                <Col xs='12' md='3' className="peopleServed rounded pt-5 pb-5">
                    <FloatIn delay={0.4}>
                        <i className="fa-solid fa-hand-holding-dollar fa-xl"/>
                        <h2>$ 5,600 Raised</h2>
                        ...
                        <img className="img img-fluid rounded" src={people} alt='donating people' />
                    </FloatIn>
                </Col>
                <Col xs='12' md='3' className="volunteers rounded pt-5 pb-5">
                    <FloatIn delay={0.6}>
                        <i className="fa-solid fa-people-carry-box fa-xl"/>
                        <h2>37,000+ SERVED</h2>
                        <p>From the homeless to those who have no where else to turn, we are committed to providing our resources across all communities</p>
                        <img className="img img-fluid rounded" src={served} alt="serving people" />
                    </FloatIn>
                </Col>
            </Row>
                <Row className="donate rounded">
                    <Col className="pt-4 pt-md-3 pb-3"><img className="img1 img-fluid rounded" src={formula} alt="baby formula"/> </Col>
                    <Col className="pb-2"><p>Your contribution helps buy tents, tables, fresh meat, and much more! Consider making a donation today. Every dollar counts.</p><a href="https://donorbox.org/test-orginization" className="btn rounded-circle" type="btn-primary">Donate</a></Col>
                </Row>
                <Row className="volunteer rounded">
                    ...
                    <Col className="pt-5 pt-md-2"> 
                        <img className="img2 img-fluid rounded" alt="Group" src={groupPhoto} />
                    </Col>
                </Row>
        </Container>
    );
